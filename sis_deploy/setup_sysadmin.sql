-- =============================================================================
-- HOL Commander v2 — SYSADMIN setup (Step 2 of 3)
-- Run this AFTER setup_accountadmin.sql has been executed by an ACCOUNTADMIN.
--
-- This script creates secrets, tables, warehouse, and stage.
-- After this, have ACCOUNTADMIN run setup_accountadmin_eai.sql (Step 3)
-- to create the EAI that references these secrets.
-- Then come back and run the stored procedures and CREATE STREAMLIT at the
-- bottom of this file (sections 5-8), which need the EAI to exist.
-- =============================================================================
...
-- *****************************************************************************
-- STOP HERE. Have ACCOUNTADMIN run setup_accountadmin_eai.sql now.
-- Then come back and run everything below this line.
-- *****************************************************************************

-- =============================================================================
-- 5. Stored Procedure: EXECUTE_REMOTE_SQL_BATCH
...
-- =============================================================================
-- 6. Stored Procedure: EXECUTE_DATAOPS_API
...
def run(session, method, path, params_json, body_json, auth_method_hint):
    ...
    params = json.loads(params_json) if params_json and params_json.strip() else None
...
-- =============================================================================
-- 7. Upload app files to stage
--    Run these after saving the files locally:
--
...
-- =============================================================================
-- 9. Populate secrets with real values
